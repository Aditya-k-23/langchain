    ...
    'obj': 
    {
        ...
        'chat_memory': 
        {
            ...
            'obj': 
                {'messages': 
                    [
                        {'data': {'additional_kwargs': {}, 'content': 'hi', 'example': False, 'type': 'human'}, 'type': 'human'}, 
                        {'data': {'additional_kwargs': {}, 'content': 'whats up', 'example': False, 'type': 'ai'}, 'type': 'ai'}
                    ]
                }, 
                'type': 'constructor'
        }, 
        ...
        'entity_summarization_prompt': 
            ...
            'input_key': None, 
            'k': 3, 
            'llm': {'id': ['tests', 'unit_tests', 'llms', 'fake_llm', 'FakeLLM'], 'lc': 1, 'repr': 'FakeLLM()', 'type': 'not_implemented'}, 
            'output_key': None, 
